...
class WorkoutModule {
  ...
  /// Muscle-group stress derived from the user's favorited workout plans, for
  /// `body_map` to render — keeps `workout` as the single source of truth for
  /// what stresses a muscle without either feature importing the other's
  /// internals.
  static Future<Map<MuscleGroup, int>> computeMuscleStress() {
    return ComputeMuscleStressUseCase(
