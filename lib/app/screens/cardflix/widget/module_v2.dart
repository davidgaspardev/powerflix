...
class ModuleV2 extends StatelessWidget {
  ...
  final CardflixController controller = Provider.getControllerByType<CardflixController>();
  ...
  Color get color {
    switch(this.data.level) {
      case "LIGHT": return appColors[0];
      case "SOFT": return appColors[1];
      case "HARD": return appColors[2];
      default: throw Exception("Level invalid");
    }
  }
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                ...
                List<Widget> widgets = [];
                if(exercise.features != null && exercise.features.length > 0) {
